    ...
    <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{route('courses.index')}}"><i class="fa-solid fa-layer-group mr-1"></i>Product Lists</a>
                <a class="collapse-item" href="{{route('courses.create')}}"><i class="fa-solid fa-square-plus mr-1"></i>Add Product</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseCategory" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{route('categories.index')}}"><i class="fa-solid fa-list mr-1"></i>Category Lists</a>
                <a class="collapse-item" href="{{route('categories.create')}}"><i class="fa-solid fa-square-plus mr-1"></i>Create Category</a>
            </div>
        </div>
    </li>
     ...
     <li class="nav-item">
        ...
        <div id="collapseLevels" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{route('levels.index')}}"><i class="fa-solid fa-layer-group mr-1"></i>Level Lists</a>
                <a class="collapse-item" href="{{route('levels.create')}}"><i class="fa-solid fa-square-plus mr-1"></i>Add Level</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseSections" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{route('sections.index')}}"><i class="fa-solid fa-layer-group mr-1"></i>Section Lists</a>
                <a class="collapse-item" href="{{route('sections.create')}}"><i class="fa-solid fa-square-plus mr-1"></i>Add Section</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseClasses" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{route('classes.index')}}"><i class="fa-solid fa-school mr-1"></i>Class Lists</a>
                <a class="collapse-item" href="{{route('classes.create')}}"><i class="fa-solid fa-square-plus mr-1"></i>Add Class</a>
            </div>
        </div>
    </li>
